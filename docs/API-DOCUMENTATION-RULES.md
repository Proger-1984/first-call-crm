...
Описаны 18 групп эндпоинтов (87 операций):
- Аутентификация (`/auth/*`)
- Пользователь (`/me/*`)
...
- Контакты (`/contacts/*`)
- Взаимодействия (`/properties/*/interactions`, `/contacts/*/interactions`)
- Напоминания (`/reminders/*`, `/properties/*/reminders`)
- Массовые операции (`/properties/bulk-action`)
